...
using Sportradar.Service.Infrastructure.Data.Mappers;
using System.Diagnostics.CodeAnalysis;

namespace Sportradar.Service.Infrastructure.Data.Repositories;

[ExcludeFromCodeCoverage]
public sealed class BetRepository : IBetRepository
{
    private readonly IDbContextFactory<SportradarDbContext> _contextFactory;

    public BetRepository(IDbContextFactory<SportradarDbContext> contextFactory)
    {
