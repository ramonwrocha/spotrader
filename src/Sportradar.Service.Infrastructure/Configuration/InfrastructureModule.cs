...
namespace Sportradar.Service.Infrastructure.Configuration;
...
public static class InfrastructureModule
{
    ...
    {
        var contextFactory = serviceProvider.GetRequiredService<IDbContextFactory<SportradarDbContext>>();
    ...
    {
        services.AddDbContextFactory<SportradarDbContext>((serviceProvider, options) =>
        {
